...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: '山草の恵みの公式サイトをリニューアルいたしました。新しいデザインで、より見やすく・使いやすくなっています。',
    category: 'news',
    publishedAt: '2026-04-20',
    body: `山草の恵みの公式サイトをリニューアルいたしました。

今回のリニューアルでは、商品情報や畑のご紹介をより見やすい形に整えました。
また、古民家の宿泊導線やブログ機能も充実させています。

引き続き、山草の恵みをよろしくお願いいたします。`,
...
漢方茶の朝食セット付きプランなど、山草の恵みらしい宿泊体験をご提供する予定です。
