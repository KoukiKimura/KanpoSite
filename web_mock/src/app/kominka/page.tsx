    ...
    <>
      ...
      <section id="kominka-overview-section" className="mock-section-kominka relative overflow-hidden">
        ...
        <div
          ...
          className="mock-shell mock-sticky-stage relative grid gap-10 py-12 md:py-16 lg:min-h-[165vh] lg:grid-cols-[0.76fr_1.24fr] lg:items-start lg:py-20"
        >
          ...
          <div id="kominka-overview-visual" className="mock-sticky-visual space-y-4">
            <div id="kominka-overview-visual-main" className="mock-image-frame mock-surface-8 min-h-[420px]">
              <img src={mockKominka.images.hero.src} alt={mockKominka.images.hero.alt} />
              <div id="kominka-overview-visual-overlay" className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/40 to-transparent px-6 py-6">
                <p id="kominka-overview-visual-overlay-text" className="mt-3 max-w-sm font-serif text-3xl text-white">
                  木の匂い、畑の風、朝の光がゆっくり重なる、静かな滞在です。
                </p>
              </div>
            </div>
            <div id="kominka-overview-visual-grid" className="grid gap-4 md:grid-cols-2">
              <div id="kominka-overview-visual-sub-1" className="mock-image-frame mock-surface-9 min-h-[220px]">
                <img src={mockKominka.images.livingRoom.src} alt={mockKominka.images.livingRoom.alt} />
              </div>
              <div id="kominka-overview-visual-sub-2" className="mock-image-frame mock-surface-10 min-h-[220px]">
      ...
      <section
        id="kominka-faded-band"
        className="mock-faded-band relative min-h-[36vh] md:min-h-[44vh]"
        style={{
          backgroundImage: `linear-gradient(rgba(41, 28, 19, 0.26), rgba(41, 28, 19, 0.48)), url(${mockKominka.images.hero.src})`,
        }}
      >
        <div className="absolute inset-0 bg-[linear-gradient(180deg,_rgba(251,248,241,0.02),_rgba(43,32,24,0.08))]" />
        <div id="kominka-faded-band-inner" className="mock-shell relative flex min-h-[36vh] items-end py-14 md:min-h-[44vh] md:py-20">
      ...
      <section id="kominka-stay-section" className="mock-section bg-[rgba(255,255,255,0.38)]">
        <div id="kominka-stay-layout" className="mock-shell grid gap-8 lg:grid-cols-[0.88fr_1.12fr]">
          <div id="kominka-stay-copy-card" className="mock-card p-8 md:p-10">
          ...
          <div id="kominka-stay-cards" className="grid gap-5 md:grid-cols-2">
            <div id="kominka-scenes-card" className="mock-card p-8">
            ...
            <div id="kominka-seasons-card" className="mock-card p-8">
